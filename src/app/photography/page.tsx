      ...
      <div className="relative bg-gradient-to-b from-primary-700 to-primary-900 h-64 md:h-80">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-4">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Photography</h1>
            <p className="text-lg text-primary-100 max-w-2xl">Capturing moments that tell stories and evoke emotions</p>
          </div>
        </div>
      </div>
      ...
      <div className="sticky top-16 z-30 bg-white/95 backdrop-blur-sm border-b border-gray-200 py-4 px-4 shadow-sm">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            {["All", "Landscape", "Urban", "Nature", "Street", "Seascape", "Portrait"].map((category) => (
              <Badge
                key={category}
                ...
                <CardContent className="p-0">
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-sm rounded-md px-3 py-1 flex items-center gap-1">
                      ...
                      <span className="text-white text-sm font-medium">{photoSeries.imageCount}</span>
                    </div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6">
                      ...
                      <h3 className="text-xl font-semibold text-white mb-1">{photoSeries.title}</h3>
                      <p className="text-gray-200 text-sm line-clamp-2">{photoSeries.description}</p>
                    </div>
