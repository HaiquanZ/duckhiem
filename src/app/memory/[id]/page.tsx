...
export default function MemoryDetailPage({
  ...
  useEffect(() => {
    async function fetchDetail() {
      if (!tripId) return;
      setLoading(true);
      const data = await getDetail<Memory>("memories", tripId);
      setMemory(data);
      setLoading(false);
    }
    fetchDetail();
  ...
  if (!tripId || (memory == null && loading == false)) {
    notFound();
  }
      ...
      <div className="relative h-[50vh] md:h-[70vh]">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
          <div className="max-w-5xl mx-auto">
            <Badge className="mb-3 bg-blue-600">{memory?.duration}</Badge>
                  ...
                  >
                    ...
                    <div>
                      ...
                      {/* <p className="text-sm text-gray-500">
                        {memory?.highlightDescriptions?.[index] ||
                          "An unforgettable experience from this journey."}
                      </p> */}
                    </div>
                  </div>
                ))}
                ...
                <Card key={index}>
                  <CardContent className="p-6 flex flex-col md:flex-row gap-6">
                    <div className="relative w-full md:w-1/3 aspect-video md:aspect-square rounded-lg overflow-hidden">
                      <Image
                        src={
                          place.image || trip.images[index % trip.images.length]
                        }
                        alt={place.name}
                        fill
                        className="object-cover"
            ...
            <div className="aspect-[16/9] bg-gray-100 rounded-lg flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <p className="text-gray-500">
                  Map showing the journey through {memory?.location}
                </p>
              </div>
            </div>
          </TabsContent>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-gray-700">{memory?.duration}</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              {/* <p className="text-gray-700">
                {memory?.transportation || "Flight, Train, and Local Transport"}
              </p> */}
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              {/* <p className="text-gray-700">
                {trip.cuisine || "Local delicacies and international cuisine"}
              </p> */}
            </CardContent>
          </Card>
        </div>
